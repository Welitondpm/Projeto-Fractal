    ...
    for m in uni2:
        ...
        for contador in range(profundidade):
            ...
            if abs(z) > lim1:
                if cores:
                    t = abs(z) / abs(c)
                    if contador <= profundidade / 9:
                        a.append(n)
                        a1.append(m)
                    elif contador >= profundidade / 9 and contador <= profundidade / 8:
                        b.append(n)
                        b1.append(m)
                    elif contador >= profundidade / 8 and contador <= profundidade / 7:
                        outroc.append(n)
                        c1.append(m)
                    elif contador >= profundidade / 7 and contador <= profundidade / 6:
                        d.append(n)
                        d1.append(m)
                        ...
                        h.append(n)
                        h1.append(m)
                    elif contador >= profundidade / 2 and contador <= profundidade / 1.5:
                        i.append(n)
                        i1.append(m)
                    elif contador >= profundidade / 1.5 and contador <= profundidade / 1.1:
                        j.append(n)
                        j1.append(m)
                    elif contador >= profundidade / 1.1:
                        k.append(n)
                        k1.append(m)
                break
            elif abs(z) < lim2:
